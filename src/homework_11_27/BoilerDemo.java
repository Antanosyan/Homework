...
public class BoilerDemo {
    public static void main(String[] args) {
        ...
        HeatingSystem apartmentSystem1 = new ApartmentHeatingSystem(130, gasBoiler, 0.5, 22); // U = 0.5 W/m²·
        HeatingSystem apartmentSystem2 = new ApartmentHeatingSystem(110, electricBoiler, 0.3, 20);
        HeatingSystem privateHouseSystem1 = new PrivateHouseHeatingSystem(200, electricBoiler, 0.4, 19);
        HeatingSystem privateHouseSystem2 = new PrivateHouseHeatingSystem(200, gasBoiler, 0.8, 29);
