...
public class PrivateHouseHeatingSystem extends HeatingSystem {
    ...
    public PrivateHouseHeatingSystem(double area, Boiler boiler, double insulation, double indoorTemp) {
        super("Private House", area * SURFACE_MULTIPLIER, boiler, insulation, indoorTemp);
    }
}
